...
if __name__ == '__main__':
    ...
    for i in range(user_number):
        IDi = "ID" + str(i)
        ti, Ti = Instantiation.Setsecval(params)
        di, Yi = Instantiation.Partialkeyext(msk, Ti, IDi, params)
        ski = Instantiation.UserPri(ti, di)
        pki = Instantiation.UserPub(Ti, Yi, IDi)
        PK.append(pki)
        SK.append(ski)
